package org.unico.gcd.soap.filter;
...
import org.unico.gcd.rest.RestPushServiceImpl;
import org.unico.gcd.utils.AuthUtils;
...
public class SoapAuthHandler implements SOAPHandler<SOAPMessageContext> {
	...
	Logger logger = LogManager.getLogger(SoapAuthHandler.class);
